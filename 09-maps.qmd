...
We can use the same logical to construct a very basic function that takes the name of a borough as input and then creates a bivarate map as output:
...
What about Kensington and Chelsea?
