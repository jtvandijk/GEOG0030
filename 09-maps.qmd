...
You can download three files below and save them in your project folder under `data/attributes`. Along with these datasets, we also have access to a `GeoPackage` that contains the 2021 LSOA boundaries.
...
1. Divide the total unemployment figures for 2011 LSOAs that have been split equally across the corresponding 2021 LSOAs.
2. Combine the total unemployment figures for 2011 LSOAs that have been merged into a single 2021 LSOA.
...
We will start by calculating unemployment rates for both years and classifying them into categories using the `biscale` library:
