...
| File                                        | Type   | Link |
| :------                                     | :------| :------ |
| London Bicycle Theft 2025                   | `GeoPackage` | [Download](https://github.com/jtvandijk/GEOG0030/raw/refs/heads/master/data/spatial/London-BicycleTheft-2025.gpkg)|
...
## Assignment
Now that we know how to work with point location data, we can again apply a similar analysis to road crashes in London in 2025 [that we used last week](02-operations.html#assignment). This time we will use this dataset to assess whether road crashes cluster in specific areas. Try the following:

1. Create a Kernel Density Estimation (KDE) of *all* road crashes that occurred in London in 2025.
