...
#| fig-lab:  Proportions of people that self-identify as Asian-Bangladeshi.
#| classes: styled-output
#| echo: True
#| eval: True
#| cache: True
...
2. Identify the `5` nearest neighbours for each municipalities, using the `knearneigh()` function.
