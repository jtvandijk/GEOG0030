...
## Assignment
Now that we are familiar with basic spatial queries and geometric operations, we can conduct a similar analysis on the number of *serious* and *fatal* road crashes in London in 2022 and determine how many occurred on or near a main road. Try to do the following:
