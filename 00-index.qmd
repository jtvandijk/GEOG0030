...
Please be aware that for this module you are expected to have access to a working **R v4.6** installation and have a basic level of proficiency in programming with R. This includes skills such as installing libraries, loading data, calculating variables, and reshaping data.
...
::: {.callout-note}
This GitHub resource has been updated for the 2026-2027 academic year. The content for 2025-2026 has been archived and can be found here: [[Link]](https://jtvandijk.github.io/GEOG0030/2025-2026/)
:::
...
- Weeks 9 and 10 now focus on AI-assisted applied spatial analysis using Microsoft Copilot.
- Weeks 1-8 now open with a short "Start of session" section outlining what will be shown live at the start of the tutorial.
- The Data Sources page is now organised by theme rather than a single long list.
- Various bug fixes and dependency updates across the course material.
:::
...
- The [GEOG0030: Geocomputation 2025-2026](https://jtvandijk.github.io/GEOG0030/2025-2026/) workbook by [Justin van Dijk](https://www.mappingdutchman.com)
